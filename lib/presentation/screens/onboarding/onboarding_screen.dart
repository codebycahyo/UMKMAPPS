...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<OnboardingData> _pages = [
    OnboardingData(
      ...
      description:
          'Aplikasi pembukuan & legalitas UMKM Indonesia.\nCatat transaksi, scan nota, dan urus sertifikasi halal — semua dalam satu aplikasi.',
      gradient: const LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
        colors: [Color(0xFF14B8A6), Color(0xFF0F766E), Color(0xFF0D5F58)],
      ),
    ),
    OnboardingData(
      icon: Icons.rocket_launch_rounded,
      title: 'AI On-Device',
      subtitle: 'Scan Nota & Catat Suara',
      description:
          'Foto nota belanja — otomatis tercatat.\nBicara saja — transaksi langsung masuk.\nSemua diproses di perangkat, tanpa internet.',
      gradient: const LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
    ...
    OnboardingData(
      ...
      subtitle: 'Wizard Halal SEHATI',
      description:
          'Lengkapi dokumen sertifikasi halal\ndengan panduan langkah demi langkah.\nData tersimpan aman di perangkat Anda.',
      gradient: const LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
        colors: [Color(0xFF5EEAD4), Color(0xFF14B8A6), Color(0xFF0D5F58)],
      ),
    ),
  ];
